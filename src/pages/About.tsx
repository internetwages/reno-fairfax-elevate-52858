            ...
            <div className="max-w-4xl mx-auto space-y-4">
              {[
                ...
                },
                {
                  number: "04",
                  title: "Construction",
                  description: "Expert installation with daily updates and a clean, organized work site.",
                },
                {
                  number: "05",
                  title: "Final Walkthrough",
                  description: "We ensure every detail meets our standards and your expectations.",
                },
              ].map((step, index) => (
                <Card
                  key={index}
