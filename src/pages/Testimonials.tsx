...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      location: "Arlington, VA",
      rating: 5,
      text: "We recently had our guest/hallway bath remodeled by Hamilton Bath.  We highly recommend them for any remodeling needs you might have.  At every step in the process, they greatly exceeded our expectations. They are very professional, knowledgeable, meticulous, and extremely hard-working. Hamid spent over an hour with us at the initial consultation, offering his expert advice on the best way to proceed with the project.  The two other companies we consulted with were in and out of our house in 10 minutes, which was disappointing.  This was our first remodel, so we found Hamid's knowledge and patience very reassuring.  He suggested Mosaic Tile for our materials, and they were excellent as well.  He also offered suggestions on how we could save money on our project.  The work began on schedule, and Hamid's employees were always on time, courteous, and very hard working.  They cleaned up the work area every day and were not intrusive at all.  Miguel is a master at his craft.  We were so impressed with his meticulous work.  Our bathroom turned out even better than we had imagined.  Hamid was always available to oversee the work and answer questions. They followed the contract terms as written.  When an issue arose once they opened up the walls, they consulted with us immediately to resolve it.  We are so pleased with Hamilton Bath's work that we have scheduled them to do our Master Bath.  I realized that this review is very long, but it is rare to find a company that is so excellent in its work and customer service.  It should be rewarded for that, so I hope this review will draw more clients to Hamilton Bath.  You will not be disappointed!",
      project: "Guest Bathroom Remodel",
    },
    {
      name: "Asha K.",
